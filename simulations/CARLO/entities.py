...
class LineEntity(Entity):
    def __init__(self, start: Point, end: Point, movable: bool = False, friction: float = 0):
        # super(LineEntity, self).__init__(start, 0, movable, friction)
        self.start = start
        self.end = end
        self.movable = movable
        self.friction = friction
    ...
    def buildGeometry(self):
        self.obj = Line(self.start, self.end)