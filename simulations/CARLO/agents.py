...
class LineDraw(LineEntity):
    def __init__(self, start: Point, end: Point, color: str = 'gray26', heading: float = 0.):
        movable = False
        friction = 0.
        super(LineDraw, self).__init__(start, end, movable, friction)
        self.color = color
        self.collidable = False
